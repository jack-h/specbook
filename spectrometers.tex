...
\begin{table}
	\caption{Some common weighting functions used in FIR filter design. \label{tab:adc}}
	\begin{tabular}{l l c c}
	\hline
	Weighting function      & $w(n)$                        & FWHM  & Peak sidelobe\\
	\hline
	\hline
	Uniform  (rectangular)   &  1                           & 1.21  &  -6.6 dB   \\
	Bartlett (triangular)    &  $1 - (|n| / (N-1)$          & 1.21  &  -13.3 dB  \\
	Hann                     & $0.5 - 0.5~cos(\frac{2\pi n}{N-1})$ & 2.00  &  -15.7 dB  \\
	Hamming             & $ 0.54 - 0.46~cos(\frac{2\pi n}{N-1})$ & 1.82 & -21.4 dB \\
	\hline
	\end{tabular}
