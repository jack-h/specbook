...
\typeout{ }
\typeout{3. Searching for ws-rv961x669.cls ... }
\IfFileExists{ws-rv961x669.cls}
    {
     \typeout{  ... ok}
    }
    {
     \typeout{* ... ws-rv961x669.cls, file not found! }
     \typeout{*}
     \typeout{* Fatal error occurred:}
     \typeout{*}
     \typeout{* The ws-rv961x669 class file which is part of the WS Review Volume distribution}
...
\typeout{ }
\typeout{4. Searching for ws-crop961x669.sty ... }
\IfFileExists{ws-crop961x669.sty}
    {
     \typeout{  ... ok}
    }
    {
     \typeout{  ... ws-crop961x669.sty, file not found! }
     \typeout{ }
     \typeout{* Warning:}
     \typeout{*}
     \typeout{* The ws-crop961x669 file which is part of the WS Books distribution}
     \typeout{* must be installed in a directory which is searched by LaTeX.}
     \typeout{*}
     \typeout{* Without this package you will not be able to typeset }
     \typeout{* your book in 961x669 trim size.}
     \typeout{*}
     \typeout{*}
     \typein{* Type <return> to continue ...}
     \errortrue
...
\IfFileExists{ws-minitoc.sty}
    ...
    }
    {
     ...
     \typeout{* must be installed in a directory which is searched by LaTeX.}
     \typeout{*}
     \typeout{* You can use the ws-rv961x669 class without this package but }
